...
private let logger = Logger(subsystem: "com.appforgestudio", category: "ModelCacheService")
...
final class ModelCacheService {
    ...
    private func writeToDisk(_ model: Model, sourceURL: URL, at diskURL: URL) {
        ...
        do {
            ...
            logger.info("[ModelCacheService] Disk write failed: \(error.localizedDescription)")
        }
    }
